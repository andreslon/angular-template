 ...
 *
 * 1) https://github.com/andreslon/angular-template/tree/master/tools
 * 2) https://github.com/andreslon/angular-template/wiki
 *
 *****************************************************************/
...
export class SeedConfig {
  ...
  */
   ...
   * @type {string}
   */
  APP_TITLE = 'Welcome to angular-template!';
