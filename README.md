...
`angular-template` provides the following features:
...
**Here is how to [speed-up the build on Windows](https://github.com/andreslon/angular-template/wiki/Speed-up-the-build-on-Windows)**.

In order to start the seed use:


```bash
$ git clone --depth 1 https://github.com/andreslon/angular-template.git
$ cd angular-template
...
Visit the [Wiki page](https://github.com/andreslon/angular-template/wiki) of the project.

# How to update?
```
git remote add upstream https://github.com/andreslon/angular-template
...
Please see the [CONTRIBUTING](https://github.com/andreslon/angular-template/blob/master/.github/CONTRIBUTING.md) file for guidelines.

# Advanced Seed Option

An [advanced option to this seed exists here](https://github.com/NathanWalker/angular-template-advanced) which shows examples of how this seed can be expanded to support:
...
- [angulartics2](https://github.com/angulartics/angulartics2) Vendor-agnostic analytics for Angular applications.
  - Out of box support for [Segment](https://segment.com/)
    - When using the seed, be sure to change your `write_key` [here](https://github.com/NathanWalker/angular-template-advanced/blob/master/src/client/index.html#L24)
...
Forks of this project demonstrate how to extend and integrate with other libraries:
 ...
 - https://github.com/andreslon/switching-to-angular2 - code samples for the book ["Switching to Angular 2"](https://www.packtpub.com/web-development/switching-angular-2).
 ...
 - https://github.com/vyakymenko/angular-template-express - integration with [Express](https://expressjs.com/) full-stack development.
 - https://github.com/UIUXEngineering/angular2-jspm-typescript-seed - integration with [JSPM](http://jspm.io/).
 - http://ngbot.io - a chat bot built with angular-template.
 - [angular-template-inspinia](https://github.com/DmitriyPotapov/angular-template-inspinia) - integration with custom design template
 ...
 - https://github.com/vyakymenko/angular-lib-starter-pack - sample how to create your library compatible with [Angular Template](https://github.com/andreslon/angular-template) with [integration guide](https://github.com/vyakymenko/angular-lib-starter-pack#test-your-library-with-angular-template-or-angular-template-express).
